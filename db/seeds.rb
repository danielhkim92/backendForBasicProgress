...
Step.create(step_title: "Routers using react-router", step_completed: false, user_id: 1)
Step.create(step_title: "Finish this project", step_completed: false, user_id: 2)
Step.create(step_title: "Give up, just joking", step_completed: false, user_id: 2)
Step.create(step_title: "Drop out", step_completed: false, user_id: 2)